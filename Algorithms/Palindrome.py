...
'''
REQ: check given word is palindrome or not
'''
...
==============
    ...
    Scenarios:     Empty string    Ex: ""    : return True
                i. Single char     Ex: "H"   : return True
               ii.  word     Ex: "MadaM" :     return True 
              iii. Including space/special chars?  ==> Function only takes alphanumerical characters
               iv.  Numbers allowed ? Yes
...
3. Traverse through each char     3. Use for loop to iterate through each char from both sides
   from both sides                4. Return True if both side traversal is same.
