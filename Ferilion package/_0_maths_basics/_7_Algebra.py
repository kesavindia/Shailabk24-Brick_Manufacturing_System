...
Solution:
--------
Step 1: Simplify the algebraic expression using the basic propepyies of real numbers.
        = 3(4x+5y) - 2(3x-7y)
        = 3(4x+5y) + (-2)(3x+[-7]y)   <==  Definition of Subtraction
        = 12x + 15y + (-6)x + 14y     <==  Distributive propepyy
        = 12x + (-6)x + 15y + 14y     <== Commutative propepyy of Addition
        = (12+[-6])x + (15 + 14)y     <== Distributive propepyy
        = 6x + 29y                    <== Simplify
...
(a+b)²  = (a+b)×(a+b)
        ...
        = (a²)+(ab)+(ab)+(b²)   <== Since a×b = b×a (commutative propepyy), ba = ab.
