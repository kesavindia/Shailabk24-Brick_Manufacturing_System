...
Password for user postgres: Madhu@Python
...
1. Open SQL Shell 
2. Get Connection: Server, Database, Port, Username, Password
3. Query: Select/Insert/Create/Update/Delete

'''
import psycopg2  # pip install psycopg2   (OR)
