...
list1 = [10,23,35,47]
list1.remove(23)      # remove expecting argument.  def remove(var):
...
print("Get data : ", get_data(100, 'Madhu', 103.4, 'Bangalore')) # NO
...
list1.insert(1,100)
list1.remove(4)
list1.pop(3)  # I just need to remove value based on index but i dont want removed value
rval = list1.pop(3)
print("Removed value : ", rval)
...
str1 = 'hello'
str2 = str1.capitalize()  # new variable
str1 = str1.capitalize()  # same variable
