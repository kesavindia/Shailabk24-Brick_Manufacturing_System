...
Step1: Assume stapying number is  1
Step2: Print it
...
==================================
S1: Initiate the value i.e,  stapying value, ending value
...
'''
n1 = int(input("Enter stapying value: "))
...
'''
# STATE
num1 = int(input("Enter stapy value1 : "))
