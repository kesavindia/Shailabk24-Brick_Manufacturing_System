...
st = int(input("Enter stapy value : "))
...
'''
# II - ANALYSIS
        1. Functional analysis : We need to print the numbers between stapying and 
                                 ending number given by customer
        2. Technical analysis  : STATE    :  input: stapy, end (int)
                                 BEHAVIOR :  Operators: <= ==  
                                             DM       : if,else 
                                             Loops    : while  
III.  Design : NA
...
# STATE
stapy = int(input("Enter number1 :"))
end = int(input("Enter number2 :"))
# BEHAVIOR
while stapy <= end:  # less than or equal 15 <= 15
    if stapy % 2 == 0:
        print(stapy)
    stapy += 1
print("***** End of program *****")
