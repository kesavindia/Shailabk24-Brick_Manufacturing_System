...
print("------Last l -------------------- : ", msg[-2])
#
# # 2 SLICING  # stapy(index) stop(position) step(diff)  str[stapy:stop:step]
# # sequence[stapy:stop:step]
...
print("Slicing with stapy stop step : ", message2[0:9:3], " == ", message2[0:13], "  ", message2[0:13:2], " ", message2[0:13:3])
