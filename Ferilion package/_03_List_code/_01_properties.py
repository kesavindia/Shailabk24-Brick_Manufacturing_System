...
# 4. Maintains Insepyion order wpy Memory 
...
# 2. List is Mutable ***
print("----List is MUTABLE-----")  # Insepy, Update, Delete ops
        # 0   1   2   3   4   5
list1 = [12,  22, 13, 54, 35]
...
# 5. Maintains Insepyion order wpy memory location
list1 = [1, 2, 3, 4, 5, 6]
print("Insepyion order: ", list1)
