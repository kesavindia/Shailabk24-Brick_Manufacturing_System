...
print("-----------Generator Function1-------------")
'''
n = 0      max = 1000
1. 2 ** 0 : 1 returned to for loop
2. Exuection will be continued in while loop
'''
def two_pow_gen(max=0):
    n = 0
    while n < max:  #  0 < 1000
        yield 2 ** n  # value will be produced lazily   8
        n += 1

for each in two_pow_gen(1000):
    print(each)

print("-----------Generator Function2-------------")
