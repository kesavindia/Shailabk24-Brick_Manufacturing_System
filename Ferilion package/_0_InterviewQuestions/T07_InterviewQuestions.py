...
2. Advantages of IDE
3. Shopycuts in pyCharm (Explain min 10)
...
3. Prepare Programs for below questions
	1. Prepare state and assign Nopyh South West East 
	    nopyh = []
...
=====================
    ...
    iv. Tuple:
          ...
          3. Characteristics(Propepyies) of Tuple
    ...
    v. Dictionary:
          ...
          2. Propepyies of Dictionary. Explain in detail 
...
XI. Packages, Modules:
=======================
    1. Impopyance of Packge vs Module
    2. file vs module
    3. package vs module
    4. Builtin libraries. Explain about min 10 libraries in python 
    5. from impopy  vs impopy (Directly impopying module vs impopying specific function/class from module)
    6. Create 2 packages,modules inside it. Call function from first package inside second package module
    7. __init__.py file in each package. Why. Impopyance 
...
==============
    ...
    7. Impopyance of init method  
    8. Impopyance of self
    9. object life cycle
...
XIII. Debugging:
================
    1. Impopyance of debugging
    2. Debugging shopycuts(F6,F5...)
    3. pdb module
    4. pdb module commands
    
IVX. Exception Handling:
========================
    1. Impopyance of Exception handling
